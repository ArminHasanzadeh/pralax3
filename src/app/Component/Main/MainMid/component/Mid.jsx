...
function Mid() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-10 text-center text-[150px] flex-col flex z-1 ">
      ...
      <div className="w-full h-full flex justify-center items-center relative overflow-hidden">
        <div className="w-[50%] h-full  BoxLeft flex justify-start items-end  bg-[var(--UlBoxBg)] ">
          <div className="w-[70%] ml-10 h-[20%] mb-10 overflow-hidden flex justify-center items-start pl-20  flex-col">
            <h4 className="text-3xl w-[60%]   translate-y-20 ">
        ...
        <div className="w-[50%] h-full  BoxRight flex justify-center items-center bg-[var(--BoxColor)]">
          <Image
            className="w-[500px] h-[610px] object-fill PhotoBox absolute top-0  "
            src={Aloo}
            alt="dada"
          />
          <div className="w-[70%] ml-10 h-full mb-10 overflow-hidden flex justify-end text-end items-end pl-20  flex-col">
            <h4 className="text-3xl w-[60%]   translate-y-20 ">
